                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-posts" style="">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('dashboard.posts.index', ['section' => $section->slug]) }}" class="nav-link">
                                ...
                                @endforeach
                                <li class="nav-item">
                                    <a href="{{ route('dashboard.posts.categories.index') }}" class="nav-link">
                                        <span class="sidenav-mini-icon"> C </span>
                                        <span class="sidenav-normal"> Categorias </span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('dashboard.posts.sections.index') }}" class="nav-link">
                                        <span class="sidenav-mini-icon"> S </span>
